...
const sections = [
  { id: 'hero-soluciones', label: 'Inicio' },
  { id: 'rpa-ia', label: 'RPA + IA' },
  { id: 'cfo-digital', label: 'CFO Digital' },
  { id: 'integraciones', label: 'Integraciones' },
  { id: 'sunat', label: 'SUNAT' },
  { id: 'copiloto-ia', label: 'Copiloto IA' },
  { id: 'ecosistema', label: 'Ecosistema' },
]

export default function ScrollProgressSoluciones() {
  const [activeSection, setActiveSection] = useState('hero-soluciones')
