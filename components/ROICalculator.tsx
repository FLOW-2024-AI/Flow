...
export default function ROICalculator() {
  ...
  return (
    <div className="bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-800 rounded-3xl p-8 md:p-12 shadow-lg transition-colors duration-300">
      ...
      >
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/40 dark:to-blue-900/30 border border-blue-200 dark:border-blue-800/50 rounded-2xl p-6 text-center shadow-sm">
          <div className="text-sm text-blue-600 dark:text-blue-300 mb-2 font-medium">Ahorro Mensual</div>
          <div className="text-3xl font-bold text-blue-900 dark:text-white">
            ${monthlySavings.toLocaleString()}
          </div>
        </div>

        <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-950/40 dark:to-emerald-900/30 border border-emerald-200 dark:border-emerald-800/50 rounded-2xl p-6 text-center shadow-sm">
          <div className="text-sm text-emerald-600 dark:text-emerald-300 mb-2 font-medium">Ahorro Anual</div>
          <div className="text-3xl font-bold text-emerald-900 dark:text-white">
            ${yearlySavings.toLocaleString()}
          </div>
        </div>

        <div className="bg-gradient-to-br from-violet-50 to-violet-100 dark:from-violet-950/40 dark:to-violet-900/30 border border-violet-200 dark:border-violet-800/50 rounded-2xl p-6 text-center shadow-sm">
          <div className="text-sm text-violet-600 dark:text-violet-300 mb-2 font-medium">ROI Anual</div>
          <div className="text-3xl font-bold text-violet-900 dark:text-white">
            {yearlyROI.toFixed(0)}%
          </div>
        </div>
      </motion.div>
