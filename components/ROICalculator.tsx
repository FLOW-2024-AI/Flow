...
export default function ROICalculator() {
  ...
  return (
    <div className="bg-gradient-to-br from-neutral-900 to-neutral-950 border border-neutral-800 rounded-3xl p-8 md:p-12">
      ...
      <div className="space-y-6 mb-8">
        ...
        <div>
          <div className="flex justify-between mb-3">
            <label className="text-neutral-300">Empleados en finanzas</label>
        ...
        <div>
          <div className="flex justify-between mb-3">
            <label className="text-neutral-300">Horas manuales por semana</label>
        ...
        <div>
          <div className="flex justify-between mb-3">
            <label className="text-neutral-300">Costo por hora (USD)</label>
