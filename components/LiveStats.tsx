    ...
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-900/10 to-purple-900/10 dark:from-blue-900/5 dark:to-purple-900/5">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="text-xs text-gray-500 dark:text-gray-500 mb-2">Transacciones procesadas</div>
              <motion.div
              ...
              <div className="text-xs text-gray-600 dark:text-gray-600">Este mes</div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="text-xs text-gray-600 dark:text-gray-600">Usando Flow ahora</div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="text-xs text-gray-500 dark:text-gray-500 mb-2">Ahorros generados</div>
              <motion.div
                key={stats.savings}
                initial={{ y: 20, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
              ...
              <div className="text-xs text-gray-600 dark:text-gray-600">Para nuestros clientes</div>
            </div>
          </motion.div>
        </div>
        ...
        <motion.p
          ...
          className="text-center text-xs text-gray-500 dark:text-gray-500 mt-8"
        >
