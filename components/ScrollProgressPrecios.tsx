...
const sections = [
  { id: 'hero-precios', label: 'Inicio' },
  { id: 'planes', label: 'Planes' },
  { id: 'comparacion', label: 'Comparación' },
  { id: 'faq-precios', label: 'FAQ' },
  { id: 'cta-precios', label: 'Prueba Gratis' },
]

export default function ScrollProgressPrecios() {
  const [activeSection, setActiveSection] = useState('hero-precios')
