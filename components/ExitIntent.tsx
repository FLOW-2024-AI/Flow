          ...
          >
            <div className="bg-neutral-900 border border-neutral-800 rounded-3xl p-8 relative">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold mb-3">¡Espera! 🎁</h3>
                <p className="text-sm text-neutral-400 mb-6">
                  Antes de irte, agenda una demo gratuita y obtén un{' '}
                  <span className="text-blue-400 font-semibold">análisis personalizado</span> de cómo Flow puede automatizar tus finanzas.
                </p>

                <div className="space-y-3">
                  <button
                    onClick={handleCTA}
                    className="w-full bg-white text-black px-6 py-3 rounded-full font-medium text-sm hover:opacity-90 transition-opacity"
                  >
