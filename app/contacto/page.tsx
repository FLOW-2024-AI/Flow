        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div className="bg-gray-100 dark:bg-[#252525] border border-gray-200 dark:border-gray-700 rounded-2xl p-8">
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-blue-50 to-primary-50 dark:from-blue-900/20 dark:to-primary-900/20 border-2 border-blue-300 dark:border-blue-500/30 rounded-2xl p-8">
                <h3 className="text-2xl font-bold mb-6">¿Necesitas ayuda rápida?</h3>
                <div className="space-y-4">
                  <Link
                    href="/consulta"
                    className="block p-4 bg-gray-100 dark:bg-[#252525] border border-gray-200 dark:border-gray-700 rounded-xl hover:border-blue-500/50 transition-colors"
                  >
              ...
              <div className="bg-gray-100 dark:bg-[#252525] border border-gray-200 dark:border-gray-700 rounded-2xl p-8">
                <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">Síguenos</h3>
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 bg-gray-900 dark:bg-white rounded-full flex items-center justify-center hover:bg-primary-500 dark:hover:bg-primary-500 transition-colors group">
                    <span className="text-sm text-white dark:text-gray-900 group-hover:text-white">𝕏</span>
                  </a>
                  <a href="#" className="w-10 h-10 bg-gray-900 dark:bg-white rounded-full flex items-center justify-center hover:bg-primary-500 dark:hover:bg-primary-500 transition-colors group">
                    <span className="text-sm text-white dark:text-gray-900 group-hover:text-white">in</span>
                  </a>
                  <a href="#" className="w-10 h-10 bg-gray-900 dark:bg-white rounded-full flex items-center justify-center hover:bg-primary-500 dark:hover:bg-primary-500 transition-colors group">
                    <span className="text-sm text-white dark:text-gray-900 group-hover:text-white">f</span>
                  </a>
                </div>
              </div>
            </div>
