      ...
      <div className="relative h-[60vh] overflow-hidden">
        ...
        >
          ...
          <Image
            ...
            alt="Equipo colaborativo trabajando juntos"
            fill
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20">
          <motion.h1
            ...
            className="text-7xl md:text-8xl font-bold text-white text-center px-4 drop-shadow-2xl"
          >
            Quiénes Somos
          </motion.h1>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="text-center">
              ...
              <motion.p 
                variants={itemVariants}
                className="text-sm text-gray-700 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed"
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-3 gap-6 pt-6">
                    <div>
                      ...
                      <div className="text-sm text-gray-700 dark:text-gray-400">Empresas confiando</div>
                    </div>
                    <div>
                      <div className="text-lg font-bold text-primary-500 dark:text-primary-400 mb-2">450%</div>
                      <div className="text-sm text-gray-700 dark:text-gray-400">ROI promedio</div>
                    </div>
                    <div>
                      <div className="text-lg font-bold text-green-400 mb-2">80%</div>
                      <div className="text-sm text-gray-700 dark:text-gray-400">Automatización activa</div>
                    </div>
                  </div>
                </div>
              </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <motion.div 
                ...
                whileHover={{ scale: 1.02, y: -5 }}
                transition={{ duration: 0.4, ease: [0.22, 1, 0.36, 1] }}
                className="group relative bg-gradient-to-br from-blue-900/30 to-primary-900/10 border border-blue-800/30 rounded-3xl p-10 overflow-hidden"
              >
                <div className="absolute top-0 right-0 w-64 h-64 bg-blue-500/10 rounded-full blur-3xl group-hover:bg-blue-500/20 transition-all duration-700" />
                <div className="relative z-10">
                  <motion.div 
                    className="w-16 h-16 bg-gradient-to-br from-blue-500 to-primary-600 rounded-2xl flex items-center justify-center mb-6 shadow-2xl shadow-blue-500/50"
                    whileHover={{ rotate: 360 }}
                    transition={{ duration: 0.6 }}
                  >
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="relative rounded-3xl overflow-hidden">
              <div className="absolute inset-0">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-b from-white/30 via-white/35 to-white/40 dark:from-[#191919]/30 dark:via-[#191919]/35 dark:to-[#191919]/40 transition-colors duration-200" />
              </div>
            ...
            <motion.div variants={itemVariants} className="relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                <motion.div 
                  ...
                  transition={{ duration: 0.4, ease: [0.22, 1, 0.36, 1] }}
                >
                  <div className="relative bg-gradient-to-br from-white to-gray-50 dark:from-neutral-900 dark:to-neutral-950 border-2 border-gray-300 dark:border-gray-700 rounded-3xl p-8 overflow-hidden shadow-lg">
                    ...
                    <div className="relative z-10 text-center">
                      <motion.div 
                        className="w-32 h-32 bg-gradient-to-br from-blue-500 via-blue-600 to-primary-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-blue-500/50"
                ...
                >
                  <div className="relative bg-gradient-to-br from-white to-gray-50 dark:from-neutral-900 dark:to-neutral-950 border-2 border-gray-300 dark:border-gray-700 rounded-3xl p-8 overflow-hidden shadow-lg">
                    <div className="absolute top-0 right-0 w-40 h-40 bg-primary-500/10 rounded-full blur-3xl group-hover:bg-primary-500/20 transition-all duration-700" />
                    <div className="relative z-10 text-center">
                      <motion.div 
                        className="w-32 h-32 bg-gradient-to-br from-primary-500 via-primary-600 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-primary-500/50"
                        whileHover={{ scale: 1.1, rotate: 5 }}
                        transition={{ duration: 0.3 }}
                      >
                        <span className="text-lg font-bold text-gray-900 dark:text-white">NV</span>
                      </motion.div>
                      <h3 className="text-base font-bold mb-2 group-hover:text-primary-500 transition-colors">Nathan Villegas</h3>
                      <p className="text-primary-500 dark:text-primary-400 font-semibold mb-4 text-sm tracking-wide">CFO & FUNDADOR</p>
                      <p className="text-sm text-gray-700 dark:text-gray-400 leading-relaxed">
                        Ex-ingeniero de <span className="text-gray-900 dark:text-white font-semibold">Yape</span>, pionero en infraestructura fintech de alto volumen. Especialista en arquitectura financiera escalable y optimización de capital para <span className="text-primary-500 dark:text-primary-400 font-semibold">hypergrowth startups</span>.
                      </p>
                    </div>
                  </div>
                </motion.div>
            ...
            >
              <div className="absolute inset-0">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-br from-blue-900/90 via-primary-900/90 to-blue-950/90" />
              </div>
              ...
              <div className="relative z-10 text-center p-16">
                <motion.h2 
                  ...
                  className="text-2xl md:text-3xl md:text-2xl md:text-3xl font-bold mb-6 leading-tight text-white"
                >
                ...
                <motion.p 
                  ...
                  className="text-sm text-white mb-10 max-w-2xl mx-auto"
                >
                ...
                >
                  <Link href="/consulta">
                    <motion.div
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="bg-white dark:bg-[#252525] text-gray-900 dark:text-gray-100 px-10 py-5 rounded-2xl font-bold text-lg hover:opacity-90 transition-all duration-200 shadow-2xl inline-block cursor-pointer"
                    >
