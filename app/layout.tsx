...
export default function RootLayout({
  ...
  return (
    <html lang="es" className="scroll-smooth" suppressHydrationWarning>
      ...
      <body className="bg-white dark:bg-[#191919] text-gray-900 dark:text-gray-100 antialiased transition-colors duration-200" style={{ fontFamily: '"Myriad Pro", "Myriad", "Liberation Sans", "Nimbus Sans L", "Helvetica Neue", Arial, sans-serif' }} suppressHydrationWarning>
        <ThemeProvider>
          {children}
        </ThemeProvider>
      </body>
