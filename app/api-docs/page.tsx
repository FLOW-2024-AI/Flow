        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-2xl p-8">
              ...
              <div className="space-y-4">
                <div className="bg-black border border-neutral-700 rounded-xl p-4">
                  ...
                  <p className="text-neutral-400 text-sm mt-2">Obtener transacciones</p>
                </div>
                <div className="bg-black border border-neutral-700 rounded-xl p-4">
                  <code className="text-blue-400 text-sm">POST /api/v1/invoices</code>
                  <p className="text-neutral-400 text-sm mt-2">Crear factura</p>
                </div>
                <div className="bg-black border border-neutral-700 rounded-xl p-4">
                  <code className="text-purple-400 text-sm">GET /api/v1/reports</code>
                  <p className="text-neutral-400 text-sm mt-2">Generar reportes</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 border border-blue-800/30 rounded-2xl p-12 text-center">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <Link
                href="/consulta"
                className="inline-block border border-neutral-700 text-white px-8 py-3 rounded-full font-semibold hover:border-neutral-500 transition-all"
              >
                Contactar ventas
              </Link>
            </div>
