          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-gray-100 dark:bg-[#252525] border border-gray-200 dark:border-gray-700 rounded-2xl p-8">
              ...
              <div className="space-y-4">
                <div className="bg-white dark:bg-[#191919] border border-gray-300 dark:border-gray-600 rounded-xl p-4">
                ...
                <div className="bg-white dark:bg-[#191919] border border-gray-300 dark:border-gray-600 rounded-xl p-4">
                  <code className="text-primary-500 dark:text-primary-400 text-sm">GET /api/v1/reports</code>
