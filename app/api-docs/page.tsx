          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-gray-100 dark:bg-neutral-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-8">
              ...
              <div className="space-y-4">
                <div className="bg-white dark:bg-neutral-950 border border-gray-300 dark:border-gray-600 rounded-xl p-4">
                ...
                <div className="bg-white dark:bg-neutral-950 border border-gray-300 dark:border-gray-600 rounded-xl p-4">
                  <code className="text-secondary-400 text-sm">GET /api/v1/reports</code>
