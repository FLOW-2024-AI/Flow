    ...
    <div className="min-h-screen bg-white dark:bg-[#191919] text-gray-900 dark:text-gray-100 transition-colors duration-200">
              ...
              <div className={index % 2 === 1 ? 'lg:order-1' : ''}>
                ...
                <div className="grid grid-cols-3 gap-4 mb-8">
                  {study.results.map((result, idx) => (
                    <div key={idx} className="bg-gray-100 dark:bg-[#252525] border border-gray-200 dark:border-gray-700 rounded-xl p-4 text-center">
                ...
                {/* Testimonial */}
                <div className="bg-gray-100 dark:bg-[#252525] border border-gray-200 dark:border-gray-700 rounded-2xl p-6">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-800/20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link href="/consulta" className="inline-block bg-white dark:bg-[#252525] text-gray-900 dark:text-gray-100 px-6 py-3 rounded-full font-medium text-sm hover:opacity-90 transition-opacity">
