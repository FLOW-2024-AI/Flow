...
export default function DashboardPage() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-white dark:bg-neutral-900 text-slate-700 dark:text-gray-100 flex items-center justify-center transition-colors duration-200">
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-900 text-slate-700 dark:text-gray-100 transition-colors duration-200">
      {/* Top Header */}
              ...
              <button
                ...
                className={`w-full flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors text-left ${
                  activeTab === 'overview' 
                    ...
                    : 'text-gray-400 dark:text-gray-300 hover:text-slate-700 dark:text-white hover:bg-gray-100 dark:bg-neutral-700'
                }`}
              >
          ...
          >
            ...
            {activeTab === 'overview' && (
              <>
                ...
                <motion.div variants={itemVariants} className="bg-gradient-to-br from-emerald-400 to-emerald-600 border-0 rounded-2xl p-4 sm:p-6 shadow-lg text-white">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div>
                      <p className="text-white/80 text-xs mb-2">Score de Salud Financiera</p>
                      <div className="flex items-baseline gap-3">
                        <p className="text-3xl sm:text-4xl font-bold text-white">{healthScore}</p>
                        <span className="text-sm text-white/80">/100</span>
                      </div>
                      <p className="text-xs text-white/80 mt-2">Excelente • +5 pts vs mes anterior</p>
                    </div>
                    <div className="relative w-20 h-20 sm:w-24 sm:h-24">
                      <svg className="w-full h-full transform -rotate-90">
                        <circle cx="48" cy="48" r="40" fill="none" stroke="currentColor" strokeWidth="6" className="text-white/30" />
                        <circle 
                          cx="48" 
                          cy="48" 
                          r="40" 
                ...
                <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                  <div className="bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl p-4 sm:p-5 text-white shadow-md">
                    <p className="text-white/80 text-xs mb-1">Liquidez</p>
                    <p className="text-xl sm:text-2xl font-bold">${(stats.saldoCaja / 1000000).toFixed(2)}M</p>
                    <p className="text-xs text-white/80 mt-1">+15% MoM</p>
                  </div>
                  <div className="bg-gradient-to-br from-emerald-500 to-emerald-700 rounded-xl p-4 sm:p-5 text-white shadow-md">
                    <p className="text-white/80 text-xs mb-1">Por Cobrar</p>
                    <p className="text-xl sm:text-2xl font-bold">${(stats.cuentasPorCobrar / 1000).toFixed(0)}K</p>
                    <p className="text-xs text-white/80 mt-1">23 facturas</p>
                  </div>
                  <div className="bg-gradient-to-br from-rose-500 to-red-600 rounded-xl p-4 sm:p-5 text-white shadow-md">
                    <p className="text-white/80 text-xs mb-1">Por Pagar</p>
                    <p className="text-xl sm:text-2xl font-bold">${(stats.cuentasPorPagar / 1000).toFixed(0)}K</p>
                    <p className="text-xs text-white/80 mt-1">Vence 7 días</p>
                  </div>
                  <div className="bg-gradient-to-br from-violet-500 to-purple-600 rounded-xl p-4 sm:p-5 text-white shadow-md">
                    <p className="text-white/80 text-xs mb-1">Flujo Neto</p>
                    <p className="text-xl sm:text-2xl font-bold">${(stats.flujoNeto / 1000).toFixed(0)}K</p>
                    <p className="text-xs text-white/80 mt-1">+22% MoM</p>
                  </div>
                </motion.div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                  {/* Ratios Clave */}
                  <motion.div variants={itemVariants} className="bg-gradient-to-br from-sky-500 to-blue-600 rounded-2xl p-4 sm:p-6 text-white shadow-lg">
                        ...
                        <div key={idx} className="flex items-center justify-between">
                          <div className="flex-1">
                            <div className="flex items-center justify-between mb-1">
                              <span className="text-sm text-white/80">{ratio.name}</span>
                              <span className={`text-xs px-2 py-0.5 rounded-full ${
                                ratio.status === 'good' ? 'bg-white/20 text-white' : 'bg-white/20 text-white'
                              }`}>
                                ✓
                              </span>
                            </div>
                            <div className="flex items-baseline gap-2">
                              ...
                              <span className="text-xs text-white/70">vs {ratio.target}</span>
                            </div>
                          </div>
                        </div>
                      ))}
                  ...
                  {/* Predicciones IA */}
                  <motion.div variants={itemVariants} className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl p-4 sm:p-6 text-white shadow-lg">
                    <h3 className="text-base sm:text-lg font-bold mb-4">Predicciones IA - Próximo Mes</h3>
                    <div className="space-y-4">
                      <div className="p-4 bg-white/15 rounded-xl">
                        <p className="text-xs text-white/80 mb-1">Ingresos Proyectados</p>
                        <p className="text-2xl font-bold text-white mb-1">$2.1M</p>
                        <p className="text-xs text-white/80">+14% vs mes actual • Confianza: 87%</p>
                      </div>
                      <div className="p-4 bg-white/15 rounded-xl">
                        <p className="text-xs text-white/80 mb-1">Gastos Estimados</p>
                        <p className="text-2xl font-bold text-white mb-1">$1.3M</p>
                        <p className="text-xs text-white/80">+8% vs mes actual • Confianza: 92%</p>
                      </div>
                      <div className="p-4 bg-white/15 rounded-xl">
                        <p className="text-xs text-white/80 mb-1">Flujo Neto Proyectado</p>
                        <p className="text-2xl font-bold text-white mb-1">$800K</p>
                        <p className="text-xs text-white/80">+22% vs mes actual • Confianza: 85%</p>
                      </div>
                    </div>
                  </motion.div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                  {/* Facturación */}
                  <motion.div variants={itemVariants} className="bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl p-4 sm:p-6 text-white shadow-lg">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-sm font-bold text-white">Facturación</h3>
                      <span className="text-xs px-2 py-1 bg-white/20 text-white rounded-full">Hoy</span>
                    </div>
                    <div className="space-y-3">
                      <div>
                        <p className="text-xs text-white/80">Emitidas</p>
                        <p className="text-xl font-bold text-white">12</p>
                        <p className="text-xs text-white/80">$45K facturado</p>
                      </div>
                      <div className="pt-3 border-t border-white/20">
                        <p className="text-xs text-white/80">Este Mes</p>
                        <p className="text-xl font-bold text-white">156</p>
                        <p className="text-xs text-white/80">$850K total</p>
                      </div>
                    </div>
                  </motion.div>

                  {/* Cobranza */}
                  <motion.div variants={itemVariants} className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-6 text-white shadow-lg">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-sm font-bold text-white">Cobranza</h3>
                      <span className="text-xs px-2 py-1 bg-white/20 text-white rounded-full">Atención</span>
                    </div>
                    <div className="space-y-3">
                      <div>
                        <p className="text-xs text-white/80">Por Vencer (7 días)</p>
                        <p className="text-xl font-bold text-white">$320K</p>
                        <p className="text-xs text-white/80">8 facturas</p>
                      </div>
                      <div className="pt-3 border-t border-white/20">
                        <p className="text-xs text-white/80">Vencidas</p>
                        <p className="text-xl font-bold text-white">$180K</p>
                        <p className="text-xs text-white/80">5 facturas • Acción requerida</p>
                      </div>
                    </div>
                  </motion.div>

                  {/* Tesorería */}
                  <motion.div variants={itemVariants} className="bg-gradient-to-br from-cyan-500 to-cyan-700 rounded-2xl p-6 text-white shadow-lg">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-sm font-bold text-white">Tesorería</h3>
                      <span className="text-xs px-2 py-1 bg-white/20 text-white rounded-full">3 Cuentas</span>
                    </div>
                    <div className="space-y-3">
                      <div>
                        <p className="text-xs text-white/80">Saldo Total</p>
                        <p className="text-xl font-bold text-white">$1.25M</p>
                        <p className="text-xs text-white/80">BCP: $850K • BBVA: $280K</p>
                      </div>
                      <div className="pt-3 border-t border-white/20">
                        <p className="text-xs text-white/80">Movimientos Hoy</p>
                        <p className="text-xl font-bold text-white">{stats.transaccionesHoy}</p>
                        <p className="text-xs text-white/80">+$125K / -$85K</p>
                      </div>
                    </div>
                  </motion.div>
                </div>
                ...
                <div className="grid lg:grid-cols-2 gap-6">
                  {/* Presupuesto */}
                  <motion.div variants={itemVariants} className="bg-gradient-to-br from-indigo-500 to-indigo-700 rounded-2xl p-6 text-white shadow-lg">
                    <h3 className="text-lg font-bold text-white mb-4">Presupuesto 2025</h3>
                    <div className="grid grid-cols-3 gap-4 mb-4">
                      ...
                      <div className="text-center p-3 bg-white/20 rounded-lg">
                        <p className="text-xs text-white/80 mb-1">Ejecutado</p>
                        <p className="text-lg font-bold text-white">$9.2M</p>
                        <p className="text-xs text-white/80">77%</p>
                      </div>
                      <div className="text-center p-3 bg-white/20 rounded-lg">
                        <p className="text-xs text-white/80 mb-1">Disponible</p>
                        <p className="text-lg font-bold text-white">$2.8M</p>
                        <p className="text-xs text-white/80">23%</p>
                      </div>
                    </div>
                      ...
                      {[
                        ...
                        <div key={idx}>
                          <div className="flex items-center justify-between text-xs mb-1">
                            ...
                            <span className="text-white">{item.exec}%</span>
                          </div>
                  ...
                  {/* Alertas Críticas */}
                  <motion.div variants={itemVariants} className="bg-gradient-to-br from-rose-500 to-rose-600 rounded-2xl p-6 text-white shadow-lg">
                    <h3 className="text-lg font-bold text-white mb-4">Alertas Críticas</h3>
                    <div className="space-y-3">
                      {[
                        ...
                        <div key={idx} className={`p-3 rounded-lg border ${
                          alert.level === 'high' ? 'bg-white/20 border-white/30' : 'bg-white/20 border-white/30'
                        }`}>
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <alert.IconComponent className="w-5 h-5 text-white" />
                              <div>
                                <p className="text-sm font-semibold text-white">{alert.type}</p>
                                <p className="text-xs text-white/80">{alert.count} items • {alert.amount}</p>
                              </div>
                            </div>
                            <button className="text-xs px-2 py-1 bg-white/30 text-white hover:bg-white/40 rounded transition-colors">
                              Ver
                            </button>
                          </div>
                        </div>
                ...
                <div className="grid lg:grid-cols-2 gap-6">
                  {/* Flujo Proyectado */}
                  <motion.div variants={itemVariants} className="bg-gradient-to-br from-violet-500 to-violet-600 rounded-2xl p-6 text-white shadow-lg">
                    <h3 className="text-lg font-bold text-white mb-4">Flujo de Caja Proyectado (12 semanas)</h3>
                    <div className="grid grid-cols-3 gap-3 mb-4">
                      <div className="text-center p-3 bg-white/20 rounded-lg">
                        <p className="text-xs text-white/80 mb-1">Saldo Inicial</p>
                        <p className="text-lg font-bold text-white">$1.25M</p>
                      </div>
                      <div className="text-center p-3 bg-white/20 rounded-lg">
                      ...
                      <div className="text-center p-3 bg-white/20 rounded-lg">
                        <p className="text-xs text-white/80 mb-1">Egresos</p>
                        <p className="text-lg font-bold text-white">-$2.4M</p>
                      </div>
                    </div>
                    <div className="p-4 bg-white/20 border border-white/30 rounded-xl">
                      <p className="text-xs text-white/80 mb-1">Saldo Final Proyectado</p>
                      <p className="text-3xl font-bold text-white mb-1">$1.65M</p>
                      <p className="text-xs text-white/80">+32% vs saldo inicial • Estado: Óptimo ✓</p>
                    </div>
                  </motion.div>

                  {/* Financiamiento Disponible */}
                  <motion.div variants={itemVariants} className="bg-gradient-to-br from-amber-500 to-amber-600 rounded-2xl p-6 text-white shadow-lg">
                    <h3 className="text-lg font-bold text-white mb-4">Financiamiento Disponible</h3>
                    <div className="space-y-3">
                      <div className="p-3 bg-white/15 border border-white/20 rounded-lg">
                        <div className="flex items-center justify-between mb-2">
                          <p className="text-sm font-semibold text-white">Ecosistema</p>
                          <span className="text-xs px-2 py-1 bg-white/20 text-white rounded-full">12 activas</span>
                        </div>
                        <p className="text-2xl font-bold mb-1 text-white">$850K</p>
                        <p className="text-xs text-white/80">Confirming • Factoring • Líneas Flash</p>
                      </div>
                      <div className="p-3 bg-white/15 border border-white/20 rounded-lg">
                        <div className="flex items-center justify-between mb-2">
                          <p className="text-sm font-semibold text-white">Bancario</p>
                          <span className="text-xs px-2 py-1 bg-white/20 text-white rounded-full">3 líneas</span>
                        </div>
                        <p className="text-2xl font-bold mb-1 text-white">$680K</p>
                        <p className="text-xs text-white/80">BCP • BBVA • Interbank • 57% disponible</p>
                      </div>
                    </div>
                  </motion.div>
                </div>
                ...
                <div className="grid lg:grid-cols-2 gap-6">
                  {/* SUNAT */}
                  <motion.div variants={itemVariants} className="bg-gradient-to-br from-teal-500 to-emerald-600 rounded-2xl p-6 text-white shadow-lg">
                    <h3 className="text-lg font-bold mb-4">Cumplimiento SUNAT</h3>
                    <div className="grid grid-cols-2 gap-3 mb-4">
                      <div className="p-3 bg-white/20 rounded-lg">
                        <p className="text-xs text-white/80 mb-1">IGV por Pagar</p>
                        <p className="text-lg font-bold text-white">$45K</p>
                        <p className="text-xs text-white/80">Vence: 15/11</p>
                      </div>
                      <div className="p-3 bg-white/20 rounded-lg">
                        <p className="text-xs text-white/80 mb-1">Renta Mensual</p>
                        <p className="text-lg font-bold text-white">$12K</p>
                        <p className="text-xs text-white/80">Vence: 20/11</p>
                      </div>
                    </div>
                    <div className="space-y-2">
                      {[
                        ...
                        <div key={idx} className="flex items-center justify-between p-2 bg-white/15 rounded">
                          <span className="text-sm text-white/80">{item.item}</span>
                  ...
                  {/* Automatizaciones */}
                  <motion.div variants={itemVariants} className="bg-gradient-to-br from-sky-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg">
                    <h3 className="text-lg font-bold mb-4">Automatizaciones</h3>
                    <div className="grid grid-cols-3 gap-3 mb-4">
                      <div className="text-center p-3 bg-white/20 rounded-lg">
                        <p className="text-2xl font-bold text-white">12</p>
                        <p className="text-xs text-white/80">Activas</p>
                      </div>
                      <div className="text-center p-3 bg-white/20 rounded-lg">
                        <p className="text-2xl font-bold text-white">48h</p>
                        <p className="text-xs text-white/80">Ahorradas/mes</p>
                      </div>
                      <div className="text-center p-3 bg-white/20 rounded-lg">
                        <p className="text-2xl font-bold text-white">89</p>
                        <p className="text-xs text-white/80">Errores evitados</p>
                      </div>
                    </div>
                    <div className="space-y-2">
                      {[
                        ...
                        <div key={idx} className="flex items-center gap-2 p-2 bg-white/15 rounded">
                ...
                {/* Quick Actions */}
                <motion.div variants={itemVariants} className="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl p-6 text-white shadow-lg">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    {[
                      ...
                      <button
                        ...
                        className="p-4 bg-white/15 hover:bg-white/25 border border-white/20 rounded-xl transition-all text-left text-white"
                      >
            ...
            {activeTab === 'analytics' && (
              <motion.div variants={itemVariants} className="bg-gradient-to-br from-indigo-500 to-blue-600 rounded-2xl p-8 text-white shadow-lg">
                  ...
                  <div className="bg-white/15 rounded-xl p-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        <span className="text-white/80">Ingresos del Mes</span>
                        <span className="text-emerald-200 font-bold">$2.1M</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-white/80">Gastos del Mes</span>
                        <span className="text-rose-200 font-bold">$1.3M</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-white/80">Margen Neto</span>
                        <span className="text-sky-200 font-bold">18%</span>
                      </div>
                    </div>
                  </div>
                  <div className="bg-white/15 rounded-xl p-6">
                    <h3 className="text-lg font-semibold mb-4 text-white">Crecimiento</h3>
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        <span className="text-white/80">vs Mes Anterior</span>
                        <span className="text-emerald-200 font-bold">+14%</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-white/80">vs Año Anterior</span>
                        <span className="text-emerald-200 font-bold">+28%</span>
                      </div>
                    </div>
                  </div>
                </div>
                <p className="text-white/80 text-center mt-8">Gráficos y análisis detallados próximamente...</p>
              </motion.div>
            )}
              ...
              <div className="space-y-6">
                ...
                <motion.div variants={itemVariants} className="grid md:grid-cols-3 gap-6">
                  <div className="bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl p-6 text-white shadow-lg">
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        <p className="text-xs text-white/80 mb-1">BCP - Corriente</p>
                    ...
                    <p className="text-xs text-white/80">+$45K hoy</p>
                  </div>

                  <div className="bg-gradient-to-br from-violet-500 to-purple-600 rounded-2xl p-6 text-white shadow-lg">
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        <p className="text-xs text-white/80 mb-1">BBVA - Corriente</p>
                    ...
                    <p className="text-xs text-white/80">-$12K hoy</p>
                  </div>

                  <div className="bg-gradient-to-br from-emerald-500 to-emerald-700 rounded-2xl p-6 text-white shadow-lg">
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        <p className="text-xs text-white/80 mb-1">Interbank - Nómina</p>
                    ...
                    <p className="text-xs text-white/80">Sin movimientos</p>
                  </div>
                </motion.div>

                {/* Movimientos del Día */}
                <motion.div variants={itemVariants} className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg">
                  <h3 className="text-lg font-bold mb-6 text-white">Movimientos de Hoy</h3>
                  <div className="space-y-4">
                    {recentTransactions.slice(0, 8).map((tx, idx) => (
                      <div key={idx} className="flex items-center justify-between p-4 bg-white/15 rounded-lg">
                        <div className="flex items-center gap-4">
                          <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${tx.type === 'ingreso' ? 'bg-white/20' : 'bg-white/20'}`}>
                            <span className="text-white">{tx.type === 'ingreso' ? '↑' : '↓'}</span>
                          </div>
                          <div>
                            <p className="text-sm font-medium text-white">{tx.concepto}</p>
                            <p className="text-xs text-white/70">{tx.cuenta}</p>
                          </div>
                        </div>
            ...
            {activeTab === 'reportes' && (
              <div className="space-y-6 text-white">
                {/* Tabs */}
                <motion.div variants={itemVariants} className="flex gap-2 border-b border-white/30">
                  <button
                    ...
                    <motion.div variants={itemVariants} className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                      {[
                        ...
                        <motion.button
                          key={idx}
                          whileHover={{ y: -4 }}
                          className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-left shadow-lg transition-all"
                        >
                          <div className="w-14 h-14 bg-white/15 rounded-xl flex items-center justify-center mb-4">
                            <report.IconComponent className="w-7 h-7 text-white" />
                          </div>
                          <h3 className="text-sm font-semibold mb-2 text-white">{report.name}</h3>
                          <p className="text-xs text-white/70">Generar reporte</p>
                        </motion.button>
                      ))}
                    </motion.div>

                    <motion.div variants={itemVariants} className="bg-gradient-to-br from-indigo-500 to-blue-600 rounded-2xl p-8 text-white shadow-lg">
                      <h3 className="text-lg font-bold mb-6 text-white">Reportes Recientes</h3>
                      <div className="space-y-4">
                        {[
                          ...
                          <div key={idx} className="flex items-center justify-between p-4 bg-white/15 rounded-lg">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-white/70">{report.date} • {report.size}</p>
                              </div>
                            </div>
                            <button className="text-xs px-3 py-1.5 bg-white/20 hover:bg-white/30 rounded-lg transition-colors text-white">
                              Descargar
                            </button>
                          </div>
                        ))}
                  ...
                  <>
                    ...
                    <motion.div variants={itemVariants} className="grid md:grid-cols-4 gap-4">
                      <div className="bg-gradient-to-br from-rose-500 to-rose-600 rounded-xl p-4 text-white shadow-md">
                        ...
                        <p className="text-xs text-white/80">Vence: 15/11/2025</p>
                      </div>
                      <div className="bg-gradient-to-br from-amber-500 to-orange-500 rounded-xl p-4 text-white shadow-md">
                        <p className="text-xs text-white/80 mb-1">Renta Mensual</p>
                        <p className="text-2xl font-bold text-white">$12K</p>
                        <p className="text-xs text-white/80">Vence: 20/11/2025</p>
                      </div>
                      <div className="bg-gradient-to-br from-sky-500 to-blue-600 rounded-xl p-4 text-white shadow-md">
                        <p className="text-xs text-white/80 mb-1">PLAME Enviado</p>
                        <p className="text-2xl font-bold text-white">✓</p>
                        <p className="text-xs text-white/80">Octubre 2025</p>
                      </div>
                      <div className="bg-gradient-to-br from-violet-500 to-purple-600 rounded-xl p-4 text-white shadow-md">
                        <p className="text-xs text-white/80 mb-1">Libros Electrónicos</p>
                        <p className="text-2xl font-bold text-white">6/6</p>
                        <p className="text-xs text-white/80">Al día</p>
                      </div>
                    </motion.div>
                    ...
                    <motion.div variants={itemVariants} className="grid md:grid-cols-2 gap-6">
                      ...
                      <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg">
                        <h3 className="text-lg font-bold mb-6 text-white">Declaraciones Mensuales</h3>
                        <div className="space-y-4">
                          {[
                            ...
                            <div key={idx} className="p-4 bg-white/15 rounded-lg">
                              <div className="flex items-center justify-between mb-2">
                                <h4 className="text-sm font-semibold text-white">{dec.name}</h4>
                              ...
                              {dec.status === 'Pendiente' && (
                                <button className="w-full mt-3 text-xs px-3 py-2 bg-white/20 hover:bg-white/30 rounded-lg transition-colors text-white">
                                  Generar y Enviar
                                </button>
                              )}
                            </div>
                      ...
                      <div className="bg-gradient-to-br from-indigo-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg">
                        <h3 className="text-lg font-bold mb-6 text-white">Libros Electrónicos (PLE)</h3>
                        <div className="space-y-4">
                          {[
                            ...
                            <div key={idx} className="flex items-center justify-between p-3 bg-white/15 rounded-lg">
                              <div>
                                <p className="text-sm font-semibold text-white">{libro.name}</p>
                                <p className="text-xs text-white/70">{libro.periodo}</p>
                              </div>
                              <div className="flex items-center gap-2">
                                <span className="text-xs px-2 py-1 bg-white/20 text-white rounded-full">
                                  {libro.status}
                                </span>
                                <button className="text-xs px-2 py-1 bg-white/20 hover:bg-white/30 rounded transition-colors text-white">
                                  Ver
                                </button>
                              </div>
                            </div>
                    ...
                    {/* SIRE y Comprobantes */}
                    <motion.div variants={itemVariants} className="bg-gradient-to-br from-violet-500 to-purple-600 rounded-2xl p-6 text-white shadow-lg">
                      <h3 className="text-lg font-bold mb-6 text-white">SIRE - Sistema Integrado de Registros Electrónicos</h3>
                      <div className="grid md:grid-cols-3 gap-6 mb-6">
                        <div className="text-center p-4 bg-white/15 rounded-xl">
                          <p className="text-xs text-white/80 mb-2">Facturas Emitidas</p>
                          <p className="text-3xl font-bold mb-1 text-white">156</p>
                          <p className="text-xs text-white/80">Octubre 2025</p>
                        </div>
                        <div className="text-center p-4 bg-white/15 rounded-xl">
                          <p className="text-xs text-white/80 mb-2">Notas de Crédito</p>
                          <p className="text-3xl font-bold mb-1 text-white">8</p>
                          <p className="text-xs text-white/80">Octubre 2025</p>
                        </div>
                        <div className="text-center p-4 bg-white/15 rounded-xl">
                          <p className="text-xs text-white/80 mb-2">Comprobantes Recibidos</p>
                          <p className="text-3xl font-bold mb-1 text-white">234</p>
                          <p className="text-xs text-white/80">Octubre 2025</p>
                        </div>
                      </div>
                      <div className="flex gap-3">
                        <button className="flex-1 text-sm px-4 py-3 bg-white/20 hover:bg-white/30 rounded-lg transition-colors text-white">
                          Enviar a SIRE
                        </button>
                        <button className="flex-1 text-sm px-4 py-3 bg-white/20 hover:bg-white/30 rounded-lg transition-colors text-white">
                          Descargar Reporte
                    ...
                    <motion.div variants={itemVariants} className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg">
                      <h3 className="text-lg font-bold mb-6 text-white">Calendario Tributario - Noviembre 2025</h3>
                      <div className="space-y-3">
                        {[
                          ...
                          <div key={idx} className="flex items-center justify-between p-4 bg-white/15 rounded-lg hover:bg-white/25 transition-colors">
                            <div className="flex items-center gap-4">
                              <div className="w-16 text-center">
                                <p className="text-xs font-bold text-white">{item.fecha}</p>
                              </div>
                              <div>
                                <p className="text-sm font-medium text-white">{item.obligacion}</p>
                              </div>
                            </div>
                            <div className="text-right">
                              <p className="text-sm font-bold text-white">{item.monto}</p>
                            </div>
                          </div>
                        ))}
                      </div>
            ...
            {activeTab === 'conciliacion' && (
              <div className="space-y-6">
                <motion.div variants={itemVariants} className="grid md:grid-cols-3 gap-6">
                  <div className="bg-gradient-to-br from-emerald-500 to-emerald-700 rounded-2xl p-6 text-white shadow-lg">
                    <p className="text-xs text-white/80 mb-2">Conciliadas</p>
                    <p className="text-3xl font-bold mb-1 text-white">35</p>
                    <p className="text-xs text-white/80">Este mes</p>
                  </div>
                  <div className="bg-gradient-to-br from-amber-500 to-orange-500 rounded-2xl p-6 text-white shadow-lg">
                    <p className="text-xs text-white/80 mb-2">Pendientes</p>
                    <p className="text-3xl font-bold mb-1 text-white">12</p>
                    <p className="text-xs text-white/80">Requieren atención</p>
                  </div>
                  <div className="bg-gradient-to-br from-rose-500 to-rose-600 rounded-2xl p-6 text-white shadow-lg">
                    <p className="text-xs text-white/80 mb-2">Discrepancias</p>
                    <p className="text-3xl font-bold mb-1 text-white">3</p>
                    <p className="text-xs text-white/80">Revisar urgente</p>
                  </div>
                </motion.div>

                <motion.div variants={itemVariants} className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg">
                  <h3 className="text-lg font-bold mb-6 text-white">Transacciones Pendientes de Conciliar</h3>
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={idx} className="flex items-center justify-between p-4 bg-white/15 rounded-lg">
                        <div className="flex items-center gap-4">
                          <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
                            <span className="text-xs font-bold text-white">{tx.banco}</span>
                          </div>
                          <div>
                            <p className="text-sm font-medium text-white">{tx.concepto}</p>
                            <p className="text-xs text-white/70">{tx.fecha}</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-4">
                          <p className="text-sm font-bold text-white">
            ...
            {activeTab === 'alertas' && (
              <div className="space-y-6">
                <motion.div variants={itemVariants} className="grid md:grid-cols-4 gap-4">
                  <div className="bg-gradient-to-br from-rose-500 to-rose-600 rounded-xl p-4 text-white shadow-md">
                    <p className="text-xs text-white/80 mb-1">Críticas</p>
                    <p className="text-2xl font-bold text-white">5</p>
                  </div>
                  <div className="bg-gradient-to-br from-amber-500 to-orange-500 rounded-xl p-4 text-white shadow-md">
                    <p className="text-xs text-white/80 mb-1">Advertencias</p>
                    <p className="text-2xl font-bold text-white">12</p>
                  </div>
                  <div className="bg-gradient-to-br from-sky-500 to-blue-600 rounded-xl p-4 text-white shadow-md">
                    <p className="text-xs text-white/80 mb-1">Informativas</p>
                    <p className="text-2xl font-bold text-white">8</p>
                  </div>
                  <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl p-4 text-white shadow-md">
                    <p className="text-xs text-white/80 mb-1">Resueltas</p>
                    <p className="text-2xl font-bold text-white">23</p>
                  </div>
                </motion.div>

                <motion.div variants={itemVariants} className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg">
                  <h3 className="text-lg font-bold mb-6 text-white">Alertas Activas</h3>
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={idx} className="flex items-start gap-4 p-4 bg-white/15 rounded-lg">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center justify-between mb-1">
                            <span className="text-xs font-semibold text-white">{alert.tipo}</span>
                            <span className="text-xs text-white/70">{alert.tiempo}</span>
                          </div>
                          <p className="text-sm text-white/80">{alert.mensaje}</p>
                        </div>
                        <button className="text-xs px-3 py-1.5 bg-white/20 hover:bg-white/30 rounded-lg transition-colors text-white">
                          Resolver
                        </button>
                ...
                <motion.div variants={itemVariants} className="grid md:grid-cols-3 gap-4">
                  <div className="bg-gradient-to-br from-sky-500 to-blue-600 rounded-xl p-4 text-white shadow-md">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <p className="text-xs font-semibold text-white">Insight del Día</p>
                    </div>
                    <p className="text-sm text-white/80">Tus gastos en Marketing aumentaron 25% este mes</p>
                  </div>
                  <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl p-4 text-white shadow-md">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center">
                      ...
                      <p className="text-xs font-semibold text-white">Oportunidad</p>
                    </div>
                    <p className="text-sm text-white/80">Puedes ahorrar $8K renegociando con proveedores</p>
                  </div>
                  <div className="bg-gradient-to-br from-amber-500 to-orange-500 rounded-xl p-4 text-white shadow-md">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center">
                      ...
                      <p className="text-xs font-semibold text-white">Recomendación</p>
                    </div>
                    <p className="text-sm text-white/80">Considera aumentar tu reserva de caja en 10%</p>
                  </div>
                </motion.div>

                {/* Chat Interface */}
                <motion.div variants={itemVariants} className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl overflow-hidden text-white shadow-lg">
                  <div className="bg-white/10 p-4 border-b border-white/20">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-sm font-semibold text-white">Copiloto Financiero</h3>
                        <p className="text-xs text-white/70">Siempre listo para ayudarte</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-4 border-t border-white/20">
                    <div className="flex gap-3">
                      <input
                        ...
                        className="flex-1 bg-white/15 border border-white/20 rounded-xl px-4 py-3 text-sm text-white placeholder-white/60 focus:outline-none focus:border-white"
                      />
                      <button className="bg-white/20 px-6 py-3 rounded-xl text-sm font-medium hover:bg-white/30 transition-opacity text-white">
                        Enviar
                      </button>
                    </div>
                    <div className="flex gap-2 mt-3">
                      {['¿Cómo va mi flujo de caja?', '¿Cuándo debo pagar facturas?', 'Analiza mis gastos'].map((q, idx) => (
                        <button key={idx} className="text-xs px-3 py-1.5 bg-white/15 hover:bg-white/25 rounded-lg transition-colors text-white">
                          {q}
                        </button>
                      ))}
                    </div>
              ...
              <div className="space-y-6">
                ...
                <motion.div variants={itemVariants} className="grid md:grid-cols-3 gap-6">
                  <div className="bg-gradient-to-br from-sky-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg">
                    <p className="text-xs text-white/80 mb-2">Ingresos Proyectados - Julio</p>
                    <p className="text-3xl font-bold mb-2 text-white">$2.1M</p>
                    <p className="text-xs text-white/80">+14% vs mes anterior</p>
                    <div className="mt-4 text-xs text-white/70">Confianza: 87%</div>
                  </div>
                  <div className="bg-gradient-to-br from-violet-500 to-purple-600 rounded-2xl p-6 text-white shadow-lg">
                    <p className="text-xs text-white/80 mb-2">Gastos Estimados - Julio</p>
                    <p className="text-3xl font-bold mb-2 text-white">$1.3M</p>
                    <p className="text-xs text-white/80">+8% vs mes anterior</p>
                    <div className="mt-4 text-xs text-white/70">Confianza: 92%</div>
                  </div>
                  <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl p-6 text-white shadow-lg">
                    <p className="text-xs text-white/80 mb-2">Flujo Neto Proyectado</p>
                    <p className="text-3xl font-bold mb-2 text-white">$800K</p>
                    <p className="text-xs text-white/80">+22% vs mes anterior</p>
                    <div className="mt-4 text-xs text-white/70">Confianza: 85%</div>
                  </div>
                </motion.div>

                {/* Predicción de Flujo de Caja */}
                <motion.div variants={itemVariants} className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-8 text-white shadow-lg">
                      ...
                      return (
                        <div key={idx} className="flex-1 flex flex-col items-center gap-2">
                          <div className="w-full h-56 flex items-end">
                            ...
                            >
                              <div className="absolute -top-12 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity bg-white/20 px-3 py-2 rounded-lg text-xs whitespace-nowrap text-white">
                                <p className="font-bold text-white">${(data.amount / 1000).toFixed(1)}M</p>
                                <p className="text-white/70">Confianza: {data.confidence}%</p>
                              </div>
                            </motion.div>
                          </div>
                          <span className="text-xs text-white/70">{data.month}</span>
                          <span className="text-xs font-semibold text-white">${(data.amount / 1000).toFixed(1)}M</span>
                        </div>
                      )
                    })}
                  </div>
                    ...
                    {[
                      ...
                      <div key={idx} className="flex items-start gap-4 p-4 bg-white/15 rounded-lg">
                        <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                          <rec.IconComponent className="w-6 h-6 text-white" />
                        </div>
                        <div className="flex-1">
                          <div className="flex items-center justify-between mb-2">
                          ...
                          <p className="text-xs text-white/70">{rec.desc}</p>
                        </div>
                        <button className="text-xs px-3 py-1.5 bg-white/20 hover:bg-white/30 rounded-lg transition-colors text-white">
                          Ver más
                        </button>
            ...
            {activeTab === 'automatizaciones' && (
              <div className="space-y-6">
                ...
                <motion.div variants={itemVariants} className="grid md:grid-cols-4 gap-4">
                  <div className="bg-gradient-to-br from-sky-500 to-blue-600 rounded-xl p-4 text-white shadow-md">
                    <p className="text-xs text-white/80 mb-1">Automatizaciones Activas</p>
                    <p className="text-2xl font-bold text-white">12</p>
                  </div>
                  <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl p-4 text-white shadow-md">
                    <p className="text-xs text-white/80 mb-1">Tiempo Ahorrado</p>
                    <p className="text-2xl font-bold text-white">48h/mes</p>
                  </div>
                  <div className="bg-gradient-to-br from-violet-500 to-purple-600 rounded-xl p-4 text-white shadow-md">
                    <p className="text-xs text-white/80 mb-1">Tareas Ejecutadas</p>
                    <p className="text-2xl font-bold text-white">1,247</p>
                  </div>
                  <div className="bg-gradient-to-br from-amber-500 to-orange-500 rounded-xl p-4 text-white shadow-md">
                    <p className="text-xs text-white/80 mb-1">Errores Evitados</p>
                    <p className="text-2xl font-bold text-white">89</p>
                  </div>
                </motion.div>
                ...
                <motion.div variants={itemVariants} className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg">
                  <div className="flex items-center justify-between mb-6">
                    <h3 className="text-lg font-bold text-white">Automatizaciones Activas</h3>
                    <button className="text-xs px-4 py-2 bg-white/20 rounded-lg hover:bg-white/30 transition-opacity text-white">
                      ...
                      <div key={idx} className="flex items-center justify-between p-4 bg-white/15 rounded-lg">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-white/70">{auto.trigger} • {auto.executions} ejecuciones</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                          <span className="text-xs px-2 py-1 bg-white/20 text-white rounded-full">
                ...
                <motion.div variants={itemVariants} className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg">
                  <h3 className="text-lg font-bold mb-6 text-white">Templates Populares</h3>
                  <div className="grid md:grid-cols-3 gap-4">
                    {[
                      ...
                      <button key={idx} className="text-left p-4 bg-white/15 hover:bg-white/25 rounded-xl transition-colors text-white">
                        <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center mb-3">
                          <template.IconComponent className="w-6 h-6 text-white" />
                        </div>
                        <h4 className="text-sm font-semibold mb-2 text-white">{template.name}</h4>
                        <p className="text-xs text-white/70 mb-3">{template.desc}</p>
                        <span className="text-xs text-white/80">Usar template →</span>
                      </button>
                    ))}
                  </div>
                </motion.div>
            ...
            {activeTab === 'salud' && (
              <div className="space-y-6">
                {/* Health Score */}
                <motion.div variants={itemVariants} className="bg-gradient-to-br from-emerald-500 to-emerald-700 rounded-2xl p-8 text-white shadow-lg">
                  <div className="flex items-center justify-between mb-8">
                    <div>
                      <h3 className="text-lg font-bold mb-2 text-white">Score de Salud Financiera</h3>
                      <p className="text-sm text-white/80">Basado en 12 indicadores clave</p>
                    </div>
                    <div className="text-center">
                      <div className="relative w-32 h-32">
                        <svg className="w-full h-full transform -rotate-90">
                          <circle cx="64" cy="64" r="56" fill="none" stroke="currentColor" strokeWidth="8" className="text-white/30" />
                          <circle 
                            cx="64" 
                            cy="64" 
                            r="56" 
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="text-center p-4 bg-white/20 rounded-xl">
                      <p className="text-xs text-white/80 mb-1">Liquidez</p>
                      <p className="text-2xl font-bold text-white">92</p>
                    </div>
                    <div className="text-center p-4 bg-white/20 rounded-xl">
                      <p className="text-xs text-white/80 mb-1">Solvencia</p>
                      <p className="text-2xl font-bold text-white">85</p>
                    </div>
                    <div className="text-center p-4 bg-white/20 rounded-xl">
                      <p className="text-xs text-white/80 mb-1">Rentabilidad</p>
                ...
                {/* Ratios Financieros */}
                <motion.div variants={itemVariants} className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg">
                  <h3 className="text-lg font-bold mb-6 text-white">Ratios Financieros Clave</h3>
                  <div className="grid md:grid-cols-2 gap-6">
                    {[
                      ...
                      <div key={idx} className="p-4 bg-white/15 rounded-lg">
                        <div className="flex items-center justify-between mb-2">
                          <h4 className="text-sm font-semibold text-white">{ratio.name}</h4>
                          <span className="text-xs px-2 py-1 rounded-full bg-white/20 text-white">
                        ...
                        <div className="flex items-baseline gap-3 mb-2">
                          ...
                          <span className="text-xs text-white/70">vs {ratio.benchmark} industria</span>
                        </div>
                        <p className="text-xs text-white/70">{ratio.desc}</p>
                      </div>
                    ))}
                  </div>
                </motion.div>
                ...
                <motion.div variants={itemVariants} className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    {[
                      ...
                      <div key={idx} className="p-4 bg-white/15 rounded-xl">
            ...
            {activeTab === 'ecosistema' && (
              <div className="space-y-6">
                ...
                <motion.div variants={itemVariants} className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {/* Confirming */}
                  <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg hover:border-orange-500/50 transition-all cursor-pointer">
                    ...
                    <button className="w-full bg-orange-600 hover:bg-orange-700 text-slate-700 dark:text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
                      Solicitar
                    </button>
                  </div>

                  {/* Factoring */}
                  <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg hover:border-blue-500/50 transition-all cursor-pointer">
                    ...
                    <button className="w-full bg-blue-600 hover:bg-blue-700 text-slate-700 dark:text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
                      Solicitar
                    </button>
                  </div>

                  {/* Línea Spot */}
                  <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg hover:border-purple-500/50 transition-all cursor-pointer">
                  ...
                  {/* Línea Flash */}
                  <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg hover:border-green-500/50 transition-all cursor-pointer">
                    ...
                    <button className="w-full bg-green-600 hover:bg-green-700 text-slate-700 dark:text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
                      Solicitar
                    </button>
                  </div>
                </motion.div>
            ...
            {activeTab === 'bancario' && (
              <div className="space-y-6">
                ...
                <motion.div variants={itemVariants} className="grid md:grid-cols-3 gap-6">
                  {/* Línea de Crédito */}
                  <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg hover:border-blue-500/50 transition-all">
                    <div className="w-12 h-12 bg-blue-900/20 rounded-xl flex items-center justify-center mb-4">
                      <svg className="w-6 h-6 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                      </svg>
                  ...
                  {/* Leasing */}
                  <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg hover:border-purple-500/50 transition-all">
                    <div className="w-12 h-12 bg-purple-900/20 rounded-xl flex items-center justify-center mb-4">
                      <svg className="w-6 h-6 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {/* Mediano Plazo */}
                  <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg hover:border-green-500/50 transition-all">
                    <div className="w-12 h-12 bg-green-900/20 rounded-xl flex items-center justify-center mb-4">
                      <svg className="w-6 h-6 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                      </svg>
                ...
                <motion.div variants={itemVariants} className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={idx} className="flex items-center justify-between p-4 bg-white/15 rounded-lg hover:bg-white/15 transition-colors">
                        <div className="flex items-center gap-4">
                          <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        {[
                          ...
                          <tr key={idx} className="border-b border-gray-200 dark:border-gray-700/50 hover:bg-white/15">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    {[
                      ...
                      <div key={idx} className={`p-4 rounded-xl border ${
                        erp.status === 'Conectado' ? 'bg-green-900/10 border-green-500/20' : 'bg-white/15 border-gray-300 dark:border-gray-600'
                      }`}>
                        <div className="flex items-center justify-between mb-3">
                          <div className="flex items-center gap-3">
                ...
                <motion.div variants={itemVariants} className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg">
                  ...
                  <div className="grid md:grid-cols-4 gap-4">
                    {[
                      ...
                      <div key={idx} className={`p-4 rounded-xl border ${
                        bank.status === 'Conectado' ? 'bg-blue-900/10 border-blue-500/20' : 'bg-white/15 border-gray-300 dark:border-gray-600'
                      }`}>
                  ...
                  <div className="grid md:grid-cols-4 gap-4">
                    {[
                      ...
                      <div key={idx} className={`p-4 rounded-xl border text-center ${
                        payment.status === 'Conectado' ? 'bg-blue-900/10 border-blue-500/20' : 'bg-white/15 border-gray-300 dark:border-gray-600'
                      }`}>
                ...
                <motion.div variants={itemVariants} className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-6 text-white shadow-lg">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    {[
                      ...
                      <div key={idx} className={`p-4 rounded-xl border ${
                        other.status === 'Conectado' ? 'bg-purple-900/10 border-purple-500/20' : 'bg-white/15 border-gray-300 dark:border-gray-600'
                      }`}>
                        <div className="flex items-center gap-3 mb-2">
